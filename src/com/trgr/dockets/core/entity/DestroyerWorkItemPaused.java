...
@Entity
@Table(name="DESTROYER_WORK_PAUSED", schema="DOCKETS_PREPROCESSOR")
public class DestroyerWorkItemPaused {
	private Long jobExecutionId;
	private Long workId;
	private String readyToResume;
	private String serverName;
	
	public DestroyerWorkItemPaused() {
		super();
	}

	public DestroyerWorkItemPaused(Long jobExecutionId, Long workId,String readyToResume) {
		super();
	...
	public boolean equals(Object obj)
	{
		...
		DestroyerWorkItemPaused other = (DestroyerWorkItemPaused) obj;
		if (workId == null)
		{
